...
function Calendar({
  ...
  return (
    <DayPicker
      ...
      classNames={{
        months:
          'flex flex-col items-center justify-center sm:flex-row space-y-4 sm:space-x-4 sm:space-y-0',
        month: 'space-y-4',
        ...
        day_today:
          'bg-eng-blue aspect-square w-10 h-10 text-white dark:bg-eng-blue dark:text-white hover:bg-eng-dark-blue',
        day_outside:
