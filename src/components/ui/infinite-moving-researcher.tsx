      ...
      >
        {items.map((item, idx) => (
          ...
          >
            ...
            >
              <Alert
                className="flex border-0 p-0 flex-col flex-1 gap-4 bg-cover bg-no-repeat bg-center"
                style={{
                  backgroundImage: `url(${urlGeral}ResearcherData/Image?researcher_id=${item.id}) `,
                }}
              >
