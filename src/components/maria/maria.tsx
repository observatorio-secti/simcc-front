...
export function Maria() {
  ...
  return (
    <main className="w-full  h-full p-4 md:p-8 pb-2 md:pb-2 ">
      <Helmet>
        <title>Pesquisa com IA | {'Simcc'}</title>
        <meta name="description" content={`Pesquisa com IA | ${'Simcc'}`} />
      ...
      <main className="grid h-full md:px-8 lg:px-32 xl:px-60 flex-1 gap-4 md:gap-8 overflow-auto   ">
        <div className="relative  flex h-full min-h-[50vh] flex-col rounded-xl bg-muted/50  ">
                  ...
                  <div>
                    <div className="flex gap-3">
                      ...
                      <h2 className="font-semibold text-5xl text-neutral-400 dark:text-neutral-300">
                        <div className="bg-gradient-to-r from-eng-blue  to-[#1B1464] text-transparent bg-clip-text text-medium">
                          Olá,
                        </div>
                        como posso ajudar?
                      </h2>
                    </div>
                    <p className="ml-12 mt-2  max-w-[550px]">
                      Faça perguntas relacionadas as produções de artigos,
                      resumo cadastrado no Lattes, livros, capítulos e patentes
                      dos docentes vinculados na plataforma{' '}
                    </p>
                  </div>
                </div>
              </div>
            ...
            <ScrollArea className="flex flex-col flex-1 h-full px-6   ">
              <div>
                {message.map((props, index) => {
                  return (
                    <div
                      className={`flex gap-3 pb-6 ${index % 2 == 0 ? 'ml-auto flex-row-reverse text-right' : ''}`}
                    >
                      {props.user == 'MarIA' ? (
                      ...
                      <div className={`flex flex-col`}>
                        <Alert
                          className={`p-4 px-6 border dark:border-neutral-800 max-w-[700px] rounded-md ${index % 2 == 0 ? 'rounded-tr-none' : 'rounded-tl-none'}`}
                        >
          ...
          <div>
            <div
              className="relative  border bg-white dark:bg-neutral-950 rounded-lg dark:border-neutral-800  "
            ...
            <p className="flex justify-center text-xs w-full mt-2 text-gray-500">
              A {'MarIA'} pode apresentar informações imprecisas, inclusive
              sobre pessoas. Por isso, cheque as respostas
            </p>
          </div>
        </div>
      </main>
