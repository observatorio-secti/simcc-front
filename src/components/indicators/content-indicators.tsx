...
export function ContentIndicators() {
    ...
    const tabs = [
        ...
        { id: "indicadores_producao", label: "Indicadores de produção", icon: BarChartBig, condition: !version, link: 'https://app.powerbi.com/view?r=eyJrIjoiMDhmMDg2ZjQtZGExMy00ZGQ4LTlkZTgtZDdhZTYzMmQ0MWQ2IiwidCI6IjcyNjE3ZGQ4LTM3YTUtNDJhMi04YjIwLTU5ZDJkMGM1MDcwNyJ9' },
        { id: "busca_informacoes", label: "Busca de informações", icon: Search, condition: !version, link: 'https://app.powerbi.com/view?r=eyJrIjoiMDJjZDg1OTQtNjZiZi00NWFkLThkMGItOTk2MWM4YTJiYTFkIiwidCI6IjcyNjE3ZGQ4LTM3YTUtNDJhMi04YjIwLTU5ZDJkMGM1MDcwNyJ9' },
        { id: "programa_pos_praduacao", label: "Programas de pós-graduação", icon: GraduationCap, condition: !version, link: 'https://app.powerbi.com/view?r=eyJrIjoiNDYyMTRhYjQtZjA3MC00YjRhLTgxOGQtODM0YWZiNmNhN2JjIiwidCI6IjcyNjE3ZGQ4LTM3YTUtNDJhMi04YjIwLTU5ZDJkMGM1MDcwNyJ9' },
        ...
        <main className="flex flex-1 h-full flex-col gap-4 p-4 md:p-8">
            ...
            <div className="w-full z-[1] gap-4">
                <div className="flex items-center gap-4">
                    ...
                    {currentTab?.id !== 'home' && (
                        <Button onClick={() => setValue('home')} variant="outline" size="icon" className="h-7 w-7">
                        ...
                        {!version && (
                            <DropdownMenu>
                                <DropdownMenuContent className="min-w-[250px]">
                                    <Link target="_blank" to={`https://simcc.uesc.br/incite/industria4/`}>
            ...
            <Tabs defaultValue={value} value={value} className="h-full flex md:items-center z-[1]">
                ...
                <TabsContent value="home" className="w-full">
                    <div className="w-full flex flex-col gap-2 py-8 md:py-12 md:pb-8 lg:py-24 lg:pb-20">
                        <Link to={'/informacoes'} className="inline-flex w-fit z-[2] items-center rounded-lg bg-neutral-100 dark:bg-neutral-700 gap-2 mb-3 px-3 py-1 text-sm font-medium">
                            <Info size={12} />
                ...
                <TabsContent value="tecnicos" className="w-full">
                    <div className="text-center p-8">
                        ...
                        <p className="text-muted-foreground mt-2">O conteúdo para esta seção será adicionado futuramente.</p>
                    </div>
                </TabsContent>
            </Tabs>
        </main>
