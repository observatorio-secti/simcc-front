    ...
    <>
      {departamentoSelecionado.length == 0 ? (
        <div className="w-full">
          <Helmet>
            <title>Departamentos | {'Simcc'}</title>
            <meta name="description" content={`Departamentos | ${'Simcc'}`} />
                        ...
                        >
                          <Masonry gutter="16px" className="w-full">
                            {filteredTotal.map((item) => (
                              <div
                                className="flex"
                                onClick={() => handlePesquisaFinal(item.dep_id)}
                              >
                                <div
                                  className={`w-2 min-w-2 rounded-l-md dark:border-neutral-800 bg-center  bg-[#719CB8]  bg-no-repeat backdrop-blur-xl  border min-h-[120px]  border-neutral-200 border-r-0 bg-  relative `}
                                ></div>
