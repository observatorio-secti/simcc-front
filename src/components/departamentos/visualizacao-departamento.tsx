...
export function VisualizacaoDepartamento() {
  ...
  const urlDados = `${urlGeral}ResearcherData/DadosGerais?year=${year}&dep_id=${type_search}`;
  ...
  const urlPalavrasChaves = `${urlGeral}lists_word_researcher?graduate_program_id=&dep_id=${type_search}&researcher_id=`;
  ...
  return (
    <main className="flex flex-1 flex-col gap-4 md:gap-8 ">
      <Helmet>
        <title>
          {departamento[0]?.dep_nom
            ? `${departamento[0]?.dep_nom} | Conectee`
            : 'Conectee | Escola de Engenharia UFMG'}
        </title>
        <meta
          name="description"
          content={
                    ...
                    <CardHeader className="flex flex-row items-start bg-neutral-100 dark:bg-neutral-800">
                      <div className="flex items-center justify-between w-full">
                        ...
                        <div className="flex gap-4 items-center justify-end flex-wrap ">
                          <div className="text-sm text-gray-500 dark:text-gray-300 font-normal flex gap-1 items-center">
                            <Mail size={16} /> {props.dep_email}
                          </div>

                          <Link to={props.dep_site} target="_blank">
                            <div className="text-sm text-gray-500 dark:text-gray-300 font-normal flex gap-1 items-center">
                              <Globe size={16} /> {props.dep_site}
                            </div>
                          </Link>
                          <div className="text-sm text-gray-500 dark:text-gray-300 font-normal flex gap-1 items-center">
                            <Phone size={16} /> {props.dep_tel}
                          </div>
                        </div>
                      </div>
                ...
                <div className="grid gap-4 md:grid-cols-2 md:gap-8 lg:grid-cols-3">
                  ...
                  <Alert className="flex flex-col lg:col-span-2 h-[450px] p-0">
                    <CardHeader className="flex md:flex-col lg:flex-row p-0 space-y-0 border-b dark:border-b-neutral-800 sm:flex-row">
                          ...
                          <div className="flex items-center gap-3">
                            ...
                            <TooltipProvider>
                              <Tooltip>
                                ...
                                <TooltipContent>
                                  <p>
                                    Essas informações não representam a produção
                                    total da Escola desde a sua fundação, é um
                                    recorte a partir de {year}
                                  </p>
                                </TooltipContent>
                              </Tooltip>
                            </TooltipProvider>
                      ...
                      <div className="flex">
                        {['producao_bibliografica', 'producao_tecnica'].map(
                          (key) => {
