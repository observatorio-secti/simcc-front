...
export function InfraestruturaPesquisa(props: Props) {
  ...
  const url = urlGeral + `labs?lattes_id=${props.lattes_id}`;
        ...
        <div className="flex flex-col mb-6 gap-6">
          {item.slice(0, 5).map((props) => (
            ...
            >
              <div className="flex ">
                <div
                  className={`w-2 min-w-2 rounded-l-md bg-eng-blue dark:border-neutral-800 border  border-neutral-200 border-r-0  min-h-full relative`}
                ></div>
                  ...
                  <div className="flex gap-1 mt-1 flex-col">
                    <div className="text-gray-500 text-sm flex gap-1 items-start">
                      ...
                      <div className="flex-1 min-w-0">
                        <p title={props.activities} className="truncate">
                          {props.activities}
                        </p>
                      </div>
                    </div>
                    ...
                    <div className="text-gray-500 text-sm flex gap-1 items-center">
                      ...
                      <div className=" gap-1 items-center flex truncate">
                        <p title={props.campus}>{props.campus}</p>{' '}
                      </div>
                    </div>
                    ...
                    <div className="text-gray-500 text-sm flex gap-1 items-center">
                      ...
                      <div className=" gap-1 items-center flex truncate">
                        <p className="truncate" title={props.location}>
                          {' '}
                          {props.location}
                        </p>
                      </div>
