          ...
          <AccordionItem value="item-1" className="text-left">
            <div className="flex mb-2">
              <HeaderResultTypeHome
                title="Gráfico de quantidade total de produção técnica"
                        ...
                        {itemsSelecionadosPopUp.map((valor, index) => {
                          return (
                            <>
                              <div
                                key={index}
                                className={`flex gap-2 items-center h-10 p-2 px-4 capitalize rounded-md text-xs bg-cyan-500 dark:bg-cyan-500 text-white border-0 `}
                              >
          ...
          <AccordionItem value="item-1">
            ...
            <AccordionContent>
              {typeVisu2 == 'block' ? (
                ...
                <TableReseracherMarcasPopup livros={software} />
              )}
            </AccordionContent>
          </AccordionItem>
        </Accordion>
          ...
          <AccordionItem value="item-1">
            <div className="flex mb-2">
              <div className="flex gap-4 w-full  justify-between items-center ">
                ...
                <div className="hidden md:flex gap-3 mr-3 items-center h-full">
                  <Button
                    onClick={() => setTypeVisu3('rows')}
                    variant={typeVisu3 == 'block' ? 'ghost' : 'outline'}
                    size={'icon'}
                  >
                    <Rows
                      size={16}
                  ...
                  <Button
                    onClick={() => setTypeVisu3('block')}
                    variant={typeVisu3 == 'block' ? 'outline' : 'ghost'}
                    size={'icon'}
                  >
                    <SquaresFour
                      size={16}
            ...
            <AccordionContent>
              {typeVisu3 == 'block' ? (
                ...
                <TableReseracherMarcasPopup livros={marca} />
              )}
            </AccordionContent>
          </AccordionItem>
        </Accordion>
