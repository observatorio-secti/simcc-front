...
export function ArticlesResearcherPopUp(props: Props) {
  ...
  const validDoiCount = publicacoes.filter(
    (pub) => pub.doi && pub.doi.trim() !== '',
  ).length;
  ...
  return (
    <>
      <div className="">
        <div className="mb-6">
          <FilterArticlePopUp onFilterUpdate={handleResearcherUpdate} />
        </div>
          ...
          <AccordionItem value="item-1">
            <div className="flex mb-2">
              <HeaderResultTypeHome
                title="Gráfico de quantidade total por Qualis"
          ...
          <AccordionItem value="item-1">
                ...
                <div className="flex gap-4 items-center">
                  ...
                  itemsSelecionadosPopUp.length == 0 ? (
                    <p className="font-medium flex gap-2  items-center ">
                      Todos os artigos
                      <p className="text-eng-blue text-sm">
                        ({percentage.toFixed(2)}% com DOI)
                      </p>
                    </p>
                  ) : (
                        ...
                        {itemsSelecionadosPopUp.map((valor, index) => {
                          return (
                            <>
                              <div
                                key={index}
                                className={`flex bg-blue-500 gap-2 items-center h-10 py-2 px-4 capitalize rounded-md text-xs text-white border-0 `}
                              >
            ...
            <AccordionContent>
              {typeVisu == 'block' ? (
                ...
                <TableReseracherArticlesPopup articles={publicacoes} />
              )}
            </AccordionContent>
          </AccordionItem>
        </Accordion>
