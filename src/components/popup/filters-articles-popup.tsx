        ...
        <Alert className="w-full">
          <DropdownMenu>
            <DropdownMenuTrigger asChild>
              <Button
                variant="ghost"
                className="w-full justify-start font-normal min-w-[220px]"
              >
                  ...
                  <div className="flex flex-wrap gap-4">
                    {itensSelecionados.map((item) => (
                      <div key={item} className="flex items-center gap-2">
                        <div
                          className={`rounded-sm h-4 w-4 ${qualisColor[item]}`}
                        ></div>
                        {item}
                      </div>
                    ))}
              ...
              {qualis.map((quali) => (
                ...
                >
                  <div className="flex gap-4 items-center">
                    <div
                      className={`flex rounded-sm h-4 w-4 ${qualisColor[quali.itens]}`}
                    ></div>
                    {quali.itens}
                  </div>
                </DropdownMenuCheckboxItem>
