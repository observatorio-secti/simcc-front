...
export function PaineisDadosExternos() {
  ...
  return (
    <main className="flex flex-1 flex-col relative  p-4 md:p-8 ">
      <Helmet>
        <title>Painéis de dados externos | {'Simcc'}</title>
        <meta
          name="description"
          content={`Painéis de dados externos | ${'Simcc'}`}
        />
      ...
      <div className="relative ">
        <div className="bg-neutral-100 mb-8 flex gap-3 dark:bg-neutral-800 w-full px-8 py-4 rounded-md">
          ...
          <div>
            ...
            <AlertDescription>
              Estes são alguns links de fontes de dados públicos que a
              plataforma acessa de forma autorizada, além de links para outras
              plataformas com objetivos semelhantes.
            </AlertDescription>
          </div>
        </div>
      ...
      <div className="md:p-16 p-4 z-[1]">
        <p className="flex-1 mb-8 shrink-0 whitespace-nowrap text-xl font-semibold tracking-tight sm:grow-0 text-white">
      ...
      <div className="md:p-16 p-4 z-[1] pt-0 md:pt-0">
        <p className="flex-1 mb-8 shrink-0 whitespace-nowrap text-xl font-semibold tracking-tight sm:grow-0 ">
          Outras plataformas
        </p>
