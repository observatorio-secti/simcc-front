...
export function SectionHome(props: Props) {
  return (
    <div
      className={`flex flex-col md:flex-row gap-8 md:gap-16 mt-8 md:mt-16 min-h-[50vh] ${props.orientation == 'right' ? 'flex-col md:flex-row ' : 'flex-col-reverse md:flex-row-reverse '}`}
    >
      ...
      <div
        className=" w-full md:w-1/2 bg-center bg-cover bg-no-repeat"
