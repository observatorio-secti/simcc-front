...
export function BannerHome() {
  ...
  useEffect(() => {
    const fetchBanners = async () => {
      ...
      const bannersRef = collection(db, 'background_iapos');
            ...
            banners.map((banner) => (
              <CarouselItem key={banner.id}>
                <div className="">
                  ...
                  >
                    <CardContent className="flex rounded-t-md lg:rounded-tr-none lg:rounded-l-md h-[300px] items-center  p-16 bg-cover bg-center">
                        ...
                        {banner.link && (
                          ...
                          >
                            <Button
                              ...
                              className="bg-transparent hover:bg-transparent dark:hover:bg-transparent dark:bg-transparent"
                              variant={'outline'}
                            >
                    ...
                    <div
                      className="bg-no-repeat h-[300px] bg-cover bg-center rounded-b-md lg:rounded-bl-none lg:rounded-r-md"
                      style={{
