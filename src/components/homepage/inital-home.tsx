...
export function InitialHome() {
    ...
    // ==============================================================
    // CONFIGURAÇÃO DA PLAYLIST DE VÍDEOS
    // ==============================================================
    const [currentVideoIndex, setCurrentVideoIndex] = useState(0);

    const playlistVideos = [
        "/vid/Bolsista-de-Produtividade_new_Feito_com_Clipchamp.mp4",
        "/vid/CadastrarOrcidLattes.mp4",
        "/vid/DOI_Feito_com_o_Clipchamp.mp4",
        "/vid/Indice-10H-correcao-grafico_Feito_com_o_Clipchamp.mp4",
        "/vid/Indice-do-Pesquisador_mod_Feito_com_o_Clipchamp.mp4",
        "/vid/IndiceH_Feito_com_o_Clipchamp.mp4",
        "/vid/JCR-Feito_com_o_Clipchamp.mp4",
        "/vid/ORCID_Feito_com_o_Clipchamp.mp4",
        "/vid/Qualis_Feito_com_o_Clipchamp.mp4"
    ];
    ...
    return (
        <div className="relative flex flex-col w-full flex-1 bg-gray-50 font-sans overflow-x-hidden">
            <Helmet>
                <title>{`Página Inicial | ${version ? 'Conectee' : 'Observatório'}`}</title>
                <meta name="description" content={`Página Inicial | ${version ? 'Conectee' : 'Observatório'}`} />
            ...
            <div className="flex-1 flex flex-col w-full">
                ...
                {/* CABEÇALHO HERO COM IMAGEM E TEXTOS INSERIDOS */}
                <div className="relative z-[1] w-full border-b border-gray-200 bg-blue-900 overflow-hidden">
                    ...
                    <div className="relative z-10 max-w-[1200px] mx-auto px-4 md:px-8 py-16 lg:py-20 flex flex-col md:flex-row justify-between items-center gap-8">
                        <div className="flex-1 max-w-3xl text-white">
                            <h1 className="text-4xl md:text-5xl lg:text-6xl font-extrabold text-white mb-4 drop-shadow-sm">
                                Observatório
                            </h1>
                            <h2 className="text-2xl font-semibold text-blue-100 mb-6 drop-shadow-sm leading-snug">
                ...
                <div className="relative z-[1] max-w-[1200px] mx-auto px-4 md:px-8 py-8 w-full">
                    ...
                    <div className="mb-12">
                        <div className="flex flex-col md:flex-row md:justify-between md:items-end mb-6 gap-4">
                            ...
                            <a 
                                href="https://observatoriocti.secti.ba.gov.br/instituicao" 
                    ...
                    <div className="grid lg:grid-cols-3 gap-6 mb-12">
                        {/* BLOCO DE VÍDEO / LOGO */}
                        <div className="bg-white/90 backdrop-blur-sm border border-gray-200 rounded-xl shadow-sm flex flex-col overflow-hidden border-t-4 border-t-blue-800 group transition-all hover:shadow-md">
                            <div className="p-5 pb-3">
                                <h3 className="text-xl font-bold text-blue-900 mb-1">Vídeo em Destaque</h3>
                                <p className="text-gray-600 text-sm line-clamp-1">Conheça a plataforma Simcc.</p>
                            </div>
                            
                            {/* Contêiner do player de vídeo */}
                            <div className="relative flex-1 bg-gray-50 w-full flex items-center justify-center border-y border-gray-100 overflow-hidden min-h-[180px]">
                                <video 
                                    key={playlistVideos[currentVideoIndex]} 
                                    className="w-full h-full max-h-[240px] object-contain"
                                    controls 
                                    poster={currentVideoIndex === 0 ? logo_observatorio : undefined}
                                    preload="metadata"
                                    onEnded={handleVideoEnded}
                                    autoPlay={currentVideoIndex > 0}
                                >
                                    <source src={playlistVideos[currentVideoIndex]} type="video/mp4" />
                            ...
                            <div className="p-4 bg-gray-50 flex justify-end items-center">
                                <Link to="/videos" className="text-red-600 hover:text-red-800 text-sm font-bold flex items-center transition-colors whitespace-nowrap">
                                    Ver mais vídeos <ArrowRight size={14} className="ml-1" />
                                </Link>
                            </div>
                        </div>

                        {/* BLOCO DE DADOS EM DESTAQUE */}
                        <div className="lg:col-span-2 bg-white/90 backdrop-blur-sm p-6 border border-gray-200 rounded-xl shadow-sm border-t-4 border-t-red-600 flex flex-col">
                            <div className="flex justify-between items-center mb-6">
                                <h3 className="text-xl font-bold text-blue-900">Dados em destaque</h3>
                                <Link to="/listagens" className="text-red-600 font-medium hover:underline text-sm flex items-center">
                                    Ver todos os dados <ArrowRight size={14} className="ml-1" />
                                </Link>
                            </div>
                            
                            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 divide-x divide-gray-100 flex-1 items-center">
