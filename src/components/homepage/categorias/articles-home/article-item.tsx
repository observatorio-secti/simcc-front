      ...
      <Alert className={`rounded-l-none flex flex-col justify-between p-0`}>
          ...
          <div>
            <div className="flex mb-1 gap-3 justify-between">
              <div>
                ...
                <h3 className="font-semibold text-left mb-4 flex flex-1">
                  {props.name_periodical}
                  {props.magazine}
                </h3>
              </div>
            ...
            <div>
              <div className="text-left">{highlightedTitleEvent}</div>
            </div>
          </div>
          <div></div>
        </div>
        <div className="flex items-center mt-4 p-4 pt-0 gap-4">
          <div className="flex flex-wrap items-center gap-4">
            ...
            <div className="text-sm text-gray-500 dark:text-gray-300 font-normal flex gap-1 items-center">
              <div
                className={`w-4 h-4 rounded-md ${qualisColor[props.qualis as keyof typeof qualisColor]}`}
              ></div>
              Qualis {props.qualis}
            ...
            {props.citations_count != '' && (
              <div className="text-sm text-gray-500 dark:text-gray-300 font-normal flex gap-1 items-center">
                <Quotes size={16} />
                Citações {props.citations_count}
              </div>
            )}
          </div>
        </div>
