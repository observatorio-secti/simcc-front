...
function BookChartsAccordion({
  loading,
  chartDataBooks,
  chartDataChapters,
}: {
  loading: boolean;
  chartDataBooks: ChartMetric[];
  chartDataChapters: ChartMetric[];
}) {
      ...
      <AccordionItem value="item-1">
        ...
        <AccordionContent>
          {loading ? (
            ...
            <GraficoLivros
              capLivros={capLivrosFormatted}
              publicacoes={publicacoesFormatted}
            />
          )}
        </AccordionContent>
      </AccordionItem>
