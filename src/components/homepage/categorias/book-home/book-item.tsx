      ...
      <Alert className="rounded-l-none flex flex-col justify-between p-0">
        ...
        <div className="flex items-center flex-wrap mt-4 gap-4">
          ...
          {props.type == 'patente' && (
            <div className="text-sm text-gray-500 dark:text-gray-300 font-normal flex gap-2 items-center">
              <div
                className={`w-4 h-4 rounded-md ${props.grant_date == 'NaT' || props.grant_date == 'None' || props.grant_date == '' ? 'bg-red-500' : 'bg-green-500'}`}
              ></div>
            ...
            <DropdownMenu>
              <DropdownMenuTrigger asChild>
                <Button
                  variant="outline"
                  size={'icon'}
                  className="ml-auto text-sm w-8 h-8 text-gray-500 dark:text-gray-300"
                >
                  <DotsThree size={16} />
                </Button>
              </DropdownMenuTrigger>
                ...
                >
                  <div className="w-6 h-6 ">
                    ...
                    <img
                      ...
                      alt=""
                      className="w-full h-full object-cover border dark:border-neutral-800 rounded-md "
                    />
                  </div>
                  {props.name}
                </DropdownMenuItem>
