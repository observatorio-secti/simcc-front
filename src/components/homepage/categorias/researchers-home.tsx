...
import { Hash, MapIcon, SlidersHorizontal, Trash, User, X } from 'lucide-react';
    ...
    if (selectedAreas.length > 0) {
      filtered = filtered.filter((r) =>
        selectedAreas.some((selectedArea) => {
          const areas =
            r.area && typeof r.area === 'string'
              ? r.area.split(';').map((area) => area.trim())
              : [];
        ...
        <AccordionContent>
          <Alert className="h-12 p-2 mb-4 flex items-center justify-between  w-full ">
            <div className="flex items-center gap-2 w-full flex-1">
              ...
              <Input
                onChange={(e) => filters.setSearch2(e.target.value)}
...
export function ResearchersHome() {
  ...
  const [researcherOpenAlex, setResearcherOpenAlex] = useState<
    ResearchOpenAlex[]
  >([]);
        ...
        try {
          do {
            const response = await fetch(
              `${urlTermPesquisadores}${sep}page=${page}`,
              {
                mode: 'cors',
                headers: {
  ...
  const totalAmong = researcher.reduce(
    (sum, researcher) => sum + researcher.among,
    0,
  );
        ...
        <div className="flex-1 gap-4 flex flex-col">
              ...
              {selectedAreas.map((item) => (
                ...
                >
                  ...
                  <div
                    onClick={() =>
                      setSelectedAreas(
                        selectedAreas.filter((area) => area !== item),
                      )
                    }
              ...
              {selectedGraduations.map((item) => (
                ...
                >
                  ...
                  <div
                    ...
                    onClick={() =>
                      setSelectedGraduations(
                        selectedGraduations.filter((i) => i !== item),
                      )
                    }
                  >
                    <X size={16} />
              ...
              {selectedDepartaments.map((item) => (
                ...
                >
                  ...
                  <div
                    ...
                    onClick={() =>
                      setSelectedDepartaments(
                        selectedDepartaments.filter((i) => i !== item),
                      )
                    }
                  >
                    <X size={16} />
              ...
              {selectedGraduatePrograms.map((item) => (
                ...
                >
                  ...
                  <div
                    ...
                    onClick={() =>
                      setSelectedGraduatePrograms(
                        selectedGraduatePrograms.filter((i) => i !== item),
                      )
                    }
                  >
                    <X size={16} />
              ...
              {selectedSubsidies.map((item) => (
                ...
                >
                  ...
                  <div
                    ...
                    onClick={() =>
                      setSelectedSubsidies(
                        selectedSubsidies.filter((i) => i !== item),
                      )
                    }
                  >
                    <X size={16} />
          ...
          {!isOpenAlex && FinalOpenAlex != 'true' && (
            <div className="grid gap-4 mt-4 md:grid-cols-2 md:gap-8 lg:grid-cols-4">
              ...
              <Alert
                className={`p-0 bg-cover bg-no-repeat bg-center ${(searchType == 'abstract' || searchType == 'name' || searchType == 'area') && 'col-span-4'}`}
              >
                <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                  <CardTitle className="text-sm font-medium">
                    ...
                    {typeVisu === 'block' ? (
                      loading ? (
                        ...
                        <ResearchersBloco
                          ...
                          onLoadMore={() =>
                            setVisibleResearchersCount((count) => count + 36)
                          }
