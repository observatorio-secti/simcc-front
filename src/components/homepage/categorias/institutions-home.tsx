...
export function InstitutionsHome() {
  ...
  const { urlGeral, searchType, valoresSelecionadosExport, navbar } =
          ...
          <AccordionItem value="item-1">
            <div className="flex ">
              <HeaderResultTypeHome
                title="Gráfico de quantidade por instituição"
            ...
            <AccordionContent>
              {loading ? (
                ...
                <div>
                  <GraficoInstitutionsHome institutions={instituicoes} />
                </div>
              )}
            </AccordionContent>
          </AccordionItem>
            ...
            <AccordionContent>
              {typeVisu == 'block' ? (
                loading ? (
                  ...
                  <InstitutionsBlock institutions={instituicoes} />
                )
              ) : loading ? (
                <Skeleton className="w-full rounded-md h-[400px]" />
              ) : (
                <TableReseracherInstitutionshome institutions={instituicoes} />
              )}
            </AccordionContent>
          </AccordionItem>
        </Accordion>
