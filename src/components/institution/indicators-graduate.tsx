...
export function IndicatorsGraduate() {
  let url =
    'https://app.powerbi.com/view?r=eyJrIjoiNTUwYTBmMGYtMDY0Mi00OTlmLWJjZDctODJhY2QyNTIyNTg1IiwidCI6IjcyNjE3ZGQ4LTM3YTUtNDJhMi04YjIwLTU5ZDJkMGM1MDcwNyJ9';

  if (true) {
    url =
      'https://app.powerbi.com/view?r=eyJrIjoiZWYwOGJjZjctMjUwZi00MmViLTllYzQtNGI5OTgxMzVhMjFmIiwidCI6IjcyNjE3ZGQ4LTM3YTUtNDJhMi04YjIwLTU5ZDJkMGM1MDcwNyJ9&pageName=ReportSection309e0a94f2ddc295a361';
  }

  let url2 =
    'https://app.powerbi.com/view?r=eyJrIjoiN2FkNjkzMmMtYjZmNy00MjY1LWFjNDktNzE3MWFiNjljZDhkIiwidCI6IjcyNjE3ZGQ4LTM3YTUtNDJhMi04YjIwLTU5ZDJkMGM1MDcwNyJ9';

  if (true) {
    url2 =
      'https://app.powerbi.com/view?r=eyJrIjoiMjA2NzFlMDEtNGQ2My00MzgzLTk5OTUtNjhmNzZkMmU1MGI4IiwidCI6IjcyNjE3ZGQ4LTM3YTUtNDJhMi04YjIwLTU5ZDJkMGM1MDcwNyJ9';
  }
  ...
  const tabs = [
    {
      id: 'indicadores',
      label: 'Indicadores de avaliação',
      icon: ChartBar,
      condition: true,
      link: 'https://app.powerbi.com/view?r=eyJrIjoiYTk2YmEwNjctMGM5Zi00Mzg5LTlhNjItYzA1NWM1YWMxMjNjIiwidCI6IjcyNjE3ZGQ4LTM3YTUtNDJhMi04YjIwLTU5ZDJkMGM1MDcwNyJ9',
    },

    {
      id: 'indicadores_conectee',
      label: 'Indicadores de avaliação',
      icon: ChartBar,
      condition: false,
      link: 'https://app.powerbi.com/view?r=eyJrIjoiNTUwYTBmMGYtMDY0Mi00OTlmLWJjZDctODJhY2QyNTIyNTg1IiwidCI6IjcyNjE3ZGQ4LTM3YTUtNDJhMi04YjIwLTU5ZDJkMGM1MDcwNyJ9',
    },
  ];
                  ...
                  {currentTab?.id != 'home' && (
                    <Link target="_blank" to={currentTab?.link || ''}>
                      <Button variant={'ghost'}>
                        <SquareArrowOutUpRight size={12} /> Abrir em outra
                        página
                      </Button>
                    </Link>
                  )}
