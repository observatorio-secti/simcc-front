...
export function VisualizacaoInstituicao() {
    ...
    const getInstitutionLink = () => {
        ...
        const foundKey = Object.keys(institutionLinks).find(key =>
            graduatePrograms.name.includes(key) || key.includes(graduatePrograms.name)
        );
                                    ...
                                    <div className="flex justify-between w-full gap-8">
                                        <div className="absolute">
                                            <Avatar
                                                ...
                                                title={getInstitutionLink() ? `Visitar site da ${graduatePrograms.name}` : ''}
                                            >
                                                <AvatarImage
