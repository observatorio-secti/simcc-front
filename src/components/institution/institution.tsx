...
import { ArrowRight, Building, ChevronDown, ChevronLeft, ChevronUp, Download, File, GraduationCap, Info, Landmark, Plus, SlidersHorizontal, Trash, X } from "lucide-react";
...
export function Institution() {
    ...
    const [originalGraduatePrograms, setOriginalGraduatePrograms] = useState<Institution[]>([]);
    ...
    return (
        <>
            ...
            <Helmet>
                <title>Instituições | {version ? ('Conectee') : ('Simcc')}</title>
                <meta name="description" content={`Instituições | ${version ? ('Conectee') : ('Simcc')}`} />
                                    ...
                                    <Accordion defaultValue="item-1" type="single" collapsible>
                                        <AccordionItem value="item-1">
                                            <div className="flex mb-2 mt-4">
                                                <HeaderResultTypeHome title="Instituções" icon={<Landmark size={24} className="text-gray-400" />}>
