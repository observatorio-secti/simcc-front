  ...
  return (
    ...
    >
      ...
      <div className="w-full flex flex-col items-center justify-center">
        ...
        <h1 className=" text-2xl md:text-4xl text-neutral-400 font-medium leading-tight tracking-tighter lg:leading-[1.1] ">
          Você não tem permissão para acessar essa página
        </h1>

        <p className="font-medium text-sm mt-2">Código do erro: 500</p>
