...
import {
  ...
  TotalInstitutions,
} from '../../components/homepage/components/carrossel-institution';
...
const initiativesList: Initiatives[] = [
  ...
  },
  {
    ...
    description:
      'Conheça a infraestrutura de pesquisa disponível na Bahia, incluindo laboratórios, equipamentos e serviços para a comunidade.',
  ...
  },
  {
    ...
    description:
      'Rede interdisciplinar que promove a popularização da ciência e fortalece a educação científica e em saúde nas escolas da Bahia.',
...
export const Observatorio = () => {
  ...
  const renderIniciativeCard = (iniciative: Initiatives) => {
    ...
    if (isComingSoon) {
      return (
        <div key={iniciative.id} className="opacity-60 cursor-not-allowed">
          {cardContent}
        </div>
      );
    }
    ...
    <main className="relative flex flex-col items-center justify-center min-h-screen p-4 md:p-8 bg-cover bg-center" style={{ backgroundImage: `url(${bg_popup})` }} >
      ...
      <div className="relative z-10 w-full">
        <Helmet>
          ...
          <meta
            name="description"
            content="Explore o Observatório de Dados Públicos de Ciência e Tecnologia da Bahia. Acesse painéis interativos sobre pesquisa, inovação, pós-graduação e mais."
          />
        ...
        <div className="flex flex-col items-center gap-6 mb-8 justify-center">
          <div className="flex-1 text-center">
            ...
            <p className="mt-2 text-neutral-600 dark:text-neutral-400 max-w-3xl mx-auto">
              Acesse visualizações de dados sobre pesquisadores, produção
              científica, infraestrutura e fomento à inovação no estado.
              Selecione um painel abaixo para começar sua análise.
            </p>
          </div>
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="min-w-max">
              <Link
                to={'https://www.fapesb.ba.gov.br/'}
                target="_blank"
                rel="noopener noreferrer"
              >
                <img
                  src={theme == 'dark' ? logo_5_white : logo_5}
                  alt="Logo do CIMATEC"
                  className="h-[96px]"
                />
              </Link>
