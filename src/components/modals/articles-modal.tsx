                  ...
                  {(data.pdf != '' ||
                    ...
                    <Link
                      ...
                      to={
                        data.pdf ||
                        data.landing_page_url ||
                        `https://doi.org/${data.doi || 'default-doi'}`
                      }
                    >
                      <Button
                        variant={'default'}
                        className="h-8  text-white dark:text-white"
                      >
                        Download do arquivo
          ...
          <ScrollArea className=" pb-4  h-[calc(100vh-50px)] p-8 flex-1">
            <div className="mb-8 flex gap-8 justify-between flex-col-reverse md:flex-row">
              <div className="">
                <div className="">
                  {data.relevance && (
                    <div className="relative mb-3  py-2 px-4 bg-yellow-600 w-fit rounded-md text-white">
                      <Star size={16} />
                    </div>
                  )}
                ...
                <div className="flex items-center flex-wrap gap-4 mt-6">
                  {data.article_institution != '' && (
                    <p className="text-gray-500 dark:text-gray-300 text-sm text-justify  flex items-center gap-1">
                      {' '}
                      <Buildings size={16} />
                      {data.article_institution}
                    </p>
              ...
              <div>
                <div>
                  <div
                    id="mudarCorDiv"
                    className={` h-16 w-16 rounded-md relative  whitespace-nowrap flex items-center justify-center  ${qualisColor[data.qualis as keyof typeof qualisColor]}`}
                  >
                    <File
                      size={36}
                      className="text-white whitespace-nowrap  w-10"
                    />
                    <p className="text-[8px] text-white absolute font-bold mt-[6px]">
                      {data.qualis}
                    </p>
                  </div>
                </div>
            ...
            <div>
              ...
              <div className="flex justify-between items-center flex-wrap">
                <div className="text-sm w-fit text-gray-500 dark:text-gray-300 font-normal flex gap-2 items-center">
                  <Avatar className="cursor-pointer rounded-md h-16 w-16">
                    <AvatarImage
                      ...
                      src={`${urlGeral}ResearcherData/Image?name=${data.researcher}`}
                    />
                ...
                <div className="flex justify-end w-full md:w-fit">
                  <Link
                    to={`/researcher?researcher_name=${data.researcher}&search_type=&terms=`}
                    target="_blank"
                  >
                    <Button size={'icon'}>
              ...
              {/* ) : (
                <div>
                  <Button
                    ...
                    variant={'outline'}
                    className="w-full border-eng-blue text-eng-blue hover:text-eng-dark-blue hover:border-eng-dark-blue"
                  >
                    <Sparkle size={16} />
                    Gerar resumo com a {'MarIA'}
                  </Button>
                  ...
                  {isTyping ? (
                    ...
                    gaia != '' && (
                      <div>
                        ...
                        <p className="text-sm text-gray-500 flex flex-wrap text-justify mt-2">
                          {parsedContent.authors.length > 0
                        ...
                        <p className="text-sm text-gray-500 flex flex-wrap font-bold text-justify mt-6">
                          A {'MarIA'} pode cometer erros. Considere verificar
                    ...
                    >
                      <Avatar className="cursor-pointer rounded-md  h-6 w-6">
                        <AvatarImage
                          ...
                          src={`${urlGeral}ResearcherData/Image?name=${author.trim()}`}
                        />
                        <AvatarFallback className="flex items-center justify-center">
                          <User size={16} />
                        </AvatarFallback>
