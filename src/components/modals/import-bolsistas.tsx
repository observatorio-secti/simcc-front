...
export function ImportBolsistas() {
  ...
  const handleSubmitPatrimonio = async () => {
    try {
      ...
      const urlPatrimonioInsert = `${urlGeralAdm}ResearcherRest/InsertGrant`;
      ...
      >
        ...
        <ScrollArea className="relative pb-4 whitespace-nowrap h-[calc(100vh-50px)] p-8 ">
          <div className="mb-8">
            ...
            <Link
              to={'http://www.bi.cnpq.br/painel/mapa-fomento-cti/'}
              target="_blank"
            ...
            >
              ...
              Saiba como extrair os bolsistas CNPq
              <ArrowRight size={12} />
            </Link>
          </div>
          <div className="">
          ...
          <div className="flex items-center justify-between">
            ...
            <Button
              onClick={() => handleSubmitPatrimonio()}
