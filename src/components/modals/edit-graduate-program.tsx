...
export function EditGraduateProgram() {
  ...
  const handleSubmit = async () => {
    if (!name)
      return toast("Campo 'Nome do programa' vazio", {
        description: 'Preencha o campo',
      });
    if (!area)
      return toast("Campo 'Área' vazio", { description: 'Preencha o campo' });
    if (!modality)
      return toast("Campo 'Modalidade' vazio", {
        description: 'Preencha o campo',
      });
    if (!type)
      return toast("Campo 'Tipo do programa' vazio", {
        description: 'Preencha o campo',
      });
    if (!city)
      return toast("Campo 'Cidade' vazio", { description: 'Preencha o campo' });
      ...
      <SheetContent className="p-0 dark:bg-neutral-900 dark:border-gray-600 min-w-[50vw]">
        ...
        <ScrollArea className="relative pb-4 whitespace-nowrap h-[calc(100vh-50px)] p-8">
          <div className="mb-8">
            ...
            <h1 className="max-w-[500px] text-3xl font-bold leading-tight md:text-4xl">
              Editar programa
            </h1>
          </div>
