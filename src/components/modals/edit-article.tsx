      ...
      <DialogContent className="z-[999999999] p-0">
        <Alert className="rounded-t-md rounded-b-none bg-eng-blue p-6 border-0 border-b">
          ...
          <DialogDescription className="text-white">
            Você pode atualizar a relevância deste artigo ou fazer upload de
            arquivos associados.
          </DialogDescription>
        </Alert>
        ...
        <DialogHeader className="p-4 pt-0 flex flex-col">
          <div className="flex gap-2 items-center pt-">
            ...
            />
            <p className="text-sm">
              {relevance ? 'Remover' : 'Adicionar'} artigo às produções
              relevantes
            </p>
          </div>
          ...
          {data.has_image ? (
            <div className="py-4">
              <div
                className="bg-neutral-100 flex justify-end group p-4 bg-center bg-cover bg-no-repeat dark:bg-neutral-800 h-[200px] rounded-md cursor-pointer"
                style={{ backgroundImage: `url(${urlGeral}image/${data.id}) ` }}
              >
                <Button
                  size={'icon'}
                  variant={'destructive'}
            ...
            <div className="">
              ...
              >
                ...
                {isDragActive ? (
                  ...
                  <p>
                    Arraste e solte a imagem aqui ou clique para selecionar o
                    arquivo
                  </p>
                )}
              </div>
              ...
              {fileInfo && (
                <div className="justify-center flex items-center gap-3 mt-2">
                  ...
                  <p className="text-center text-zinc-500 text-sm">
                    Arquivo selecionado: ({(fileInfo.size / 1024).toFixed(2)}{' '}
                    KB)
                  </p>
                </div>
              )}
