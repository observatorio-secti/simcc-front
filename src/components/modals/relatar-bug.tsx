...
export function RelatarBug() {
  ...
  const handleSubmit = async () => {
    try {
      ...
      const urlProgram = urlGeralAdm + 's/feedback';
            ...
            <div className="flex flex-col w-full">
              <div className="bg-neutral-100 flex gap-3 dark:bg-neutral-800 w-full px-8 py-4 rounded-md">
                ...
                <div>
                  ...
                  <AlertDescription className="whitespace-normal">
                    Faça um breve comentário do erro encontrado para que
                    possamos corrigir o mais rápido possível, contamos com seu
                    feedback!
                  </AlertDescription>
                </div>
              </div>
              ...
              <div className="flex flex-col gap-2 mt-4 ">
                ...
                <ToggleGroup
                  ...
                  type="single"
                  variant={'outline'}
                  className="grid grid-cols-5 md:flex md:flex-wrap gap-3"
                >
