      ...
      >
        ...
        <ScrollArea className="relative pb-4 whitespace-nowrap h-[calc(100vh-50px)] p-8 ">
          ...
          <div className="">
            <div
              {...getRootProps()}
              className="border-dashed mb-6 flex-col border border-neutral-300 p-6 text-center rounded-md text-neutral-400 text-sm  cursor-pointer transition-all gap-3  w-full flex items-center justify-center hover:bg-neutral-100 mt-4"
            >
              <input {...getInputProps()} />
          ...
          <div className="flex items-center justify-between">
            <div className="text-sm font-gray-500">
              {uploadProgress
                ? 'Isso pode demorar bastante, não feche a página.'
                : ''}
            </div>
            <Button
              onClick={() => handleSubmitBolsista()}
              className="ml-auto flex mt-3"
            >
              {uploadProgress ? (
              ...
              {uploadProgress ? 'Atualizando dados' : 'Atualizar dados'}
            </Button>
          </div>
        </ScrollArea>
      </SheetContent>
