...
import { LayoutPanelTop, Palette, SquarePlus, X } from 'lucide-react';
import {
  Tooltip,
  TooltipContent,
  TooltipProvider,
...
import {
  ...
  items,
  itemsEspeciais,
} from '../dashboard/builder-page/builder-page';
                    ...
                    <Tooltip>
                      <TooltipTrigger>
                        <Button
                          ...
                          variant={tab == 'inicio' ? 'outline' : 'ghost'}
                          size={'icon'}
                        >
                    ...
                    <Tooltip>
                      <TooltipTrigger>
                        <Button
                          ...
                          variant={tab == 'themes' ? 'outline' : 'ghost'}
                          size={'icon'}
                        >
                          <Palette size={16} />
                        </Button>
                ...
                <div className="h-full  w-full border rounded-md">
                  <TabsContent value="inicio" className="m-0 p-4">
                    <h3 className="text-3xl font-semibold">
                      Olá, vamos começar personalizando a página
                    </h3>
                    <p className="text-sm text-gray-500 pt-2 pb-8">
                      Comece adicionando sessões e alterando as cores do layout
                    </p>
                    ...
                    <Accordion type="single" collapsible>
                      <AccordionItem value="item-1">
                        <AccordionTrigger className="py-2 border-b">
                          Informações
                        </AccordionTrigger>
