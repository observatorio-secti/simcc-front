...
import { ArrowCounterClockwise, ArrowUUpLeft } from 'phosphor-react';
      ...
      <DialogContent>
        <DialogHeader className="pt-8 px-6 flex flex-col items-center">
          ...
          <DialogDescription className="text-center text-zinc-500">
            Você tem certeza de que deseja prosseguir e resetar os pesos de
            produções? Isso irá impactar os índices de produções
          </DialogDescription>
        </DialogHeader>
