...
export function UserProfileInitialModal() {
  ...
  const isModalOpen =
    (isOpen && typeModal === 'user-profile-initial') || isModalOpen1;
      ...
      items: [
        {
          ...
          description:
            'Busque por termos nas produções técnicas e científicas.',
          active: true,
        },
        {
          ...
          description:
            'Visualize indicadores de produção científica e técnica de maneira integrada.',
          active: false,
        },
        {
          ...
          description:
            'Identifique pesquisadores e grupos de pesquisa para promover colaborações eficazes.',
          active: false,
        },
        {
          ...
          description:
            'Pesquise produções científicas com o objetivo de realizar revisões sistemáticas.',
          active: false,
        },
        {
          ...
          description:
            'Leia artigos científicos qualificados ou com fator de impacto.',
          active: false,
        },
        {
          ...
          description:
            'Considere indicadores docentes e produções para futura participação.',
          active: false,
        },
      ],
    },
    {
      ...
      items: [
        ...
        },
        {
          ...
          description:
            'Acompanhe indicadores de produção científica e técnica.',
          active: false,
        },
        {
          ...
          description:
            'Descubra as competências das instituições e dos pesquisadores.',
          active: false,
        },
        {
          icon: <Search className="w-6 h-6 text-gray-400" />,
        ...
        },
        {
          ...
          description:
            'Identifique grupos de pesquisa, bolsistas e projetos das instituições.',
          active: false,
        },
        {
          icon: <GraduationCap className="w-6 h-6 text-gray-400" />,
          ...
          description:
            'Planeje financiamentos e induções futuras com base nos programas de pós-graduação.',
          active: false,
        },
        {
          ...
          description:
            'Receba um relatório semanal com novas produções da instituição.',
          active: false,
        },
      ],
    },
      ...
      items: [
        {
          ...
          description:
            'Analise os indicadores do programa para elaborar estratégias.',
          active: true,
        },
        {
          ...
          description:
            'Gerencie a atualização dos currículos Lattes do corpo docente.',
          active: false,
        },
        {
          icon: <Users className="w-6 h-6 text-gray-400" />,
          ...
          description:
            'Saiba quais professores são bolsistas de produtividade e líderes de grupos de pesquisa.',
          active: false,
        },
        {
          icon: <FileText className="w-6 h-6 text-gray-400" />,
    ...
    },
    {
      ...
      items: [
        ...
        },
        {
          ...
          description:
            'Administre pesquisadores e programas de pós-graduação dentro da plataforma.',
          active: false,
        },
        {
          ...
          description:
            'Desenvolva seus próprios índices e estatísticas para análise.',
          active: false,
        },
      ],
    },
                ...
                <div className="grid  items-center gap-5">
                  ...
                  >
                    {perfis.map((props, index) => (
                      <ToggleGroupItem
                        className="flex aspect-square flex-1 py-6 w-full h-full flex-col  items-center gap-2"
                        key={index}
                        value={props.name}
                      >
                        <props.icon size={32} />
                    ...
                    {resposta.map(
                      (step, index) =>
                        ...
                        step.items?.map(
                          (
                            props,
                            subIndex, // Verificando se step.name é igual a "perfil"
                          ) => (
                            <div
                              key={`${index}-${subIndex}`}
              ...
              <ScrollArea className="h-[350px]">
                ...
                <div className="mt-4">
                  <h1 className=" text-2xl mb-2 font-medium">
                    Apresentamos a plataforma {'Simcc'}
                  </h1>
                  <p className="text-sm text-justify text-gray-500">
                    O {'Simcc'} é uma plataforma inovadora desenvolvida para
                    facilitar a busca, filtragem e análise das produções
                    técnicas e bibliográficas dos pesquisadores. Com uma
                    interface intuitiva, você pode explorar publicações,
                    projetos e indicadores de impacto de forma rápida e
                    eficiente. Conecte-se ao conhecimento e descubra insights
                    valiosos para suas pesquisas e colaborações!
                  </p>
                </div>
            ...
            <div className="flex gap-2 ">
              <Link to={'/termos-uso'} target="_blank">
                ...
                <Button variant={'ghost'}>
                  <InfoIcon size={16} /> Termos de uso
                </Button>
              </Link>
            </div>
            <div className="flex gap-2 ">
