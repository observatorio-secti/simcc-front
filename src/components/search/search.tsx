      ...
      if (char === '(') {
        ...
        if (temp.trim()) {
          ...
          terms.forEach((term, index) => {
            if (term) {
              result.push({
                term: term + (index < terms.length - 1 ? ';' : '|'),
              });
            }
          });
          temp = '';
                ...
                <div className="hidden md:flex gap-2 w-fit  items-center">
                  <div className="flex items-center gap-2">
                    {/*
                                        ...
                                        />
                                        <Label className="flex gap-2 items-center">{false ? ('GaIA') : ('MarIA')}<Chats size={16} className="" /></Label>
                                        */}
                  </div>

                  {!maria && <SelectTypeSearch />}
                          ...
                          <>
                            ...
                            {index < itemsSelecionados.length - 1 && (
                              <button
                                ...
                                onClick={() => {
                                  const connector = itemsSelecionados[
                                    index
                                  ].term.endsWith('|')
                                    ? ';'
                                    : '|';
