...
import { Books, Quotes, StripeLogo } from 'phosphor-react';
...
export function NewsArticles() {
  ...
  return (
    <main
      ref={containerRef}
      className="  bg-neutral-50 dark:bg-neutral-900 w-full"
    >
      <Helmet>
        <title>Produções recentes | {'Simcc'}</title>
        <meta name="description" content={`Produções recentes | ${'Simcc'}`} />
