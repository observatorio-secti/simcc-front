...
export function Mobile() {
  ...
  return (
    <div
      ...
      className="h-screen  z-[999999999999999999999999999] sm:hidden fixed top-0 left-0  bg-cover bg-no-repeat bg-center w-full flex flex-col items-center justify-center bg-neutral-50 dark:bg-neutral-900"
    >
      ...
      <div className="w-full flex flex-col items-center justify-center">
        ...
        <h1 className=" text-2xl text-neutral-400 font-medium leading-tight text-center px-8 tracking-tighter lg:leading-[1.1] ">
          Página indisponível para o mobile, acesse por outro meio.
        </h1>
      </div>
    </div>
  );
