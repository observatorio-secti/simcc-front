...
export function HomepageProgram(props: Props) {
  ...
  const urlTermPublicacoes =
    urlGeral +
    `recently_updated?year=2024&university=&graduate_program_id=${type_search}`;
  ...
  return (
    <main className="h-full w-full flex flex-col">
      ...
      <AdminGraficoGraduateProgram
        graduate_program_id={props.program.graduate_program_id}
      />
    </main>
  );
}
