...
export function GraficoProducaoGeralSection(props: Props) {
  ...
  const total = useMemo(
    () => ({
      ...
      producao_tecnica: props.dados.reduce(
        (acc, curr) =>
          ...
          <CardHeader className="flex p-0 flex-row items-center justify-between space-y-0 ">
            ...
            <div className="flex items-center gap-3">
              <Select
                ...
                onValueChange={(value) => props.setYear(Number(value))}
              >
              ...
              <TooltipProvider>
                <Tooltip>
                  ...
                  <TooltipContent>
                    <p>
                      Essas informações não representam a produção total da
                      Escola desde a sua fundação, é um recorte a partir de{' '}
                      {props.year}
                    </p>
                  </TooltipContent>
                </Tooltip>
