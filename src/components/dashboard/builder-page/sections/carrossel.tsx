        ...
        <CarouselContent className="-ml-1">
                ...
                <Alert className="flex gap-2   p-4  w-full rounded-t-none ">
                  <div className="w-full gap-2 flex flex-1 flex-col">
                    <Input
                      ...
                      onChange={(e) => {
                        ...
                        newContent[props.index] = {
                          ...newContent[props.index],
                          items: updatedItems,
                        }; // Atualiza a lista de itens no objeto content
                      ...
                      className="rounded-none font-medium text-lg  w-full bg-transparent border-0 p-0 dark:border-0 dark:bg-transparent"
                    ...
                    <Input
                      ...
                      className="text-gray-500  rounded-none text-sm w-full bg-transparent border-0 p-0 dark:border-0 dark:bg-transparent"
                    ...
                    <Popover>
                      ...
                      <PopoverContent className="flex w-[400px]  items-end gap-3 ">
                        ...
                        <Button
                          ...
                          className="min-w-10"
                          onClick={() => {
                            const updatedItems = props.contentItem.items.filter(
                              (_, i) => i !== idx,
                            );
                            const newContent = [...props.keepoData.content];
                            newContent[props.index] = {
          ...
          <CarouselItem className="pl-1 md:basis-1/2 lg:basis-1/3">
            <div className="p-1 h-full">
              <Alert
                className=" h-full font-medium  flex-col  cursor-pointer hover:bg-neutral-100 transition-all dark:hover:bg-neutral-800 flex items-center justify-center gap-3"
                onClick={() => addSocialItem(props.index)}
              >
                <div>
                  <Plus size={32} />
                </div>
