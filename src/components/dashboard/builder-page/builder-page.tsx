...
import { EyeClosed, Gear } from 'phosphor-react';
...
export const items = [
  {
    titulo: 'Divisão',
    desc: 'Dividir blocos visualmente',
    icon: <Rows size={16} />,
    type: 'divider' as const,
  },
  {
    titulo: 'Título 1',
    desc: 'Título da seção grande',
    icon: <Heading1 size={16} />,
    type: 'h1' as const,
  },
  {
    titulo: 'Título 2',
    desc: 'Título da seção média',
    icon: <Heading2 size={16} />,
    type: 'h2' as const,
  },
  {
    titulo: 'Título 3',
    desc: 'Título da seção pequena',
    icon: <Heading3 size={16} />,
    type: 'h3' as const,
  },
  {
    titulo: 'Parágrafo',
    desc: 'Escreva um texto sem formatação',
    icon: <AlignLeft size={16} />,
    type: 'text' as const,
  },
  {
    titulo: 'Lista com marcadores',
    desc: 'Criar lista com marcadores simples',
    icon: <List size={16} />,
    type: 'list' as const,
  },
  {
    titulo: 'Lista numerada',
    desc: 'Criar lista com numeração',
    icon: <ListOrdered size={16} />,
    type: 'list-number' as const,
  },
  {
    titulo: 'Vídeo',
    desc: 'Carregar ou integrar com um link',
    icon: <SquarePlay size={16} />,
    type: 'video' as const,
  },
  {
    titulo: 'Imagem',
    desc: 'Fazer upload do arquivo',
    icon: <Image size={16} />,
    type: 'image' as const,
  },
  {
    titulo: 'Carrossel',
    desc: 'Crie uma sessão com os cards',
    icon: <GalleryHorizontal size={16} />,
    type: 'slider' as const,
  },
  {
    titulo: 'Link',
    desc: 'Criar link para página externa',
    icon: <Link size={16} />,
    type: 'link' as const,
  },
  {
    titulo: 'Card',
    desc: 'Crie blocos de conteúdo',
...
export const itemsEspeciais = [
  {
    titulo: 'Gráfico',
    desc: 'Quantidade e métricas de produções',
    icon: <BarChart size={16} />,
    type: 'grafico' as const,
  },
  {
    titulo: 'Pesquisadores',
    desc: 'Carrossel de participantes',
    icon: <Users size={16} />,
    type: 'pesquisadores' as const,
  },
  {
    titulo: 'Nuvem de palavras',
    desc: 'Palavras com maiores ocorrências',
    icon: <Users size={16} />,
    type: 'nuvem-palavra' as const,
  },
  {
    titulo: 'Tabela',
    desc: 'Dados de produção',
    icon: <Table size={16} />,
    type: 'tabela' as const,
  },
  {
    titulo: 'Todos os artigos',
    desc: 'Artigos dos pesquisadores',
    icon: <File size={16} />,
    type: 'artigos' as const,
  },
  {
    titulo: 'Todos os livros',
    desc: 'Livros dos pesquisadores',
    icon: <BookOpen size={16} />,
    type: 'livros' as const,
  },
  {
    titulo: 'Todos os livros e capítulos',
    desc: 'Livros e capítulos dos pesquisadores',
    icon: <Book size={16} />,
    type: 'capitulos' as const,
  },
  {
    titulo: 'Todos os livros e capítulos',
    desc: 'Livros e capítulos dos pesquisadores',
    icon: <Book size={16} />,
    type: 'patentes' as const,
  },
  {
    titulo: 'Todos os livros e capítulos',
    desc: 'Livros e capítulos dos pesquisadores',
    icon: <Book size={16} />,
    type: 'sotwares' as const,
  },
  {
    titulo: 'Todos os livros e capítulos',
    desc: 'Livros e capítulos dos pesquisadores',
    icon: <Book size={16} />,
    type: 'marcas' as const,
  },
];
...
export function BuilderPage() {
  ...
  useEffect(() => {
    if (documentId && keepoData && isDataLoaded.current) {
      const saveData = async () => {
        await setDoc(doc(db, 'construtor-pagina', documentId), keepoData, {
          merge: true,
        });
      };
      saveData();
    ...
    fileInput.onchange = async (event) => {
      ...
      setKeepoData((prev) => ({
        ...
        app: {
          ...prev.app,
          background_image:
            folder === 'background' ? downloadURL : prev.app.background_image,
        },
        profile_info: {
          ...prev.profile_info,
  ...
  return (
    <main className="h-full p-8 flex gap-3">
      <Helmet>
        <title>Construtor de página | Módulo administrativo | {'Simcc'} </title>
        <meta
          name="description"
          content={`Construtor de página | Módulo administrativo | ${'Simcc'}`}
        />
        ...
        >
          <Alert className="w-full px-2 h-[48px]  rounded-md flex items-center  justify-between">
            <div className="flex items-center gap-4">
              ...
              <h1 className="flex-1 shrink-0 whitespace-nowrap text- font-semibold tracking-tight sm:grow-0">
                Voltar
              </h1>
            </div>
            ...
            <div>
              <div className="ml-28 px-2 pb-2 flex flex-col gap-2 mr-8">
                <Alert
                  ...
                  style={{
                    backgroundImage: `url(${keepoData.app.background_image})`,
                  }}
                >
                  <Button
                    variant="outline"
                ...
                <div className="relative group w-fit -top-16 px-16">
                  <Alert
                    ...
                    style={{
                      backgroundImage: `url(${keepoData.profile_info.avatar})`,
                    }}
                  ></Alert>
              ...
              <div className="flex gap-2 items-center">
                ...
                <Input
                  onChange={(e) => setSearchTerm(e.target.value)}
                  id="searchInput"
                  className="bg-transparent border-0 p-0 dark:border-0 dark:bg-transparent"
