...
import { Books, StripeLogo, Trash } from 'phosphor-react';
...
export function DisplayItem(props: Patrimonio) {
  ...
  const handleVisibleProgram = (id: string) => {
    const urlVisibleProgram =
      urlGeralAdm + `GraduateProgramRest/Update?graduate_program_id=${id}`;
        ...
        <div className="flex items-center p-2 justify-between">
          <div className="flex items-center gap-2">
            ...
            <Tooltip>
              <TooltipTrigger asChild>
                <Link
                  to={`/pos-graduacao?graduate_program_id=${props.graduate_program_id}`}
                  target="_blank"
                >
                ...
                <Button
                  onClick={() =>
                    onOpen('confirm-delete-pos-graduate-program', {
                      id_delete: props.graduate_program_id,
                      name: props.name,
                    })
                  }
                  variant="destructive"
