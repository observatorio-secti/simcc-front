...
export function HomeDashboard() {
  ...
  return (
    <main className="w-full md:p-8 p-4">
      <Helmet>
        <title>Dashboard | Módulo administrativo | {'Simcc'}</title>
        <meta
          name="description"
          content={`Dashboard | Módulo administrativo | ${'Simcc'}`}
        />
      ...
      <div className="bg-eng-blue rounded-md w-full h-[40vh] text-white p-8 flex flex-col justify-between">
        <div>
          <Badge className="mb-4 text-eng-blue" variant="secondary">
            {role}
          </Badge>
        </div>
        ...
        <div>
          <div className="gap-2">
            <h1 className="max-w-[750px] mb-2 text-lg font-light text-foreground">
