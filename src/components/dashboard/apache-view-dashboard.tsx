        ...
        <pre>
          <ScrollArea className="h-[300px]">
            <code className="grid gap-1 text-sm text-muted-foreground [&_span]:h-4">
              <span className="text-gray-500 text-sm text-muted-foreground">
                conectee: ~ <span className="text-sky-500">(apachehop)</span>$
              </span>
              {researcher.map((props) => {
                return (
                  <span className="text-gray-500 text-sm">
                    conectee: ~{' '}
                    <span className="text-sky-500">(apachehop)</span>${' '}
                    {props.message}
                  </span>
                );
              })}
