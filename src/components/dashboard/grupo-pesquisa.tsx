              ...
              <Tabs defaultValue={tab} value={tab}>
                <div className="flex items-center justify-between px-4 py-2  h-[56px]">
                  ...
                  <Link
                    ...
                    target="_blank"
                    className="inline-flex items-center rounded-lg  bg-neutral-100 dark:bg-neutral-700  gap-2  px-3 py-1 text-sm font-medium"
                  >
                    <Info size={12} />
              ...
              {total ? (
                ...
                <div className="w-full h-full flex flex-col items-center justify-center">
                  ...
                  <p className="font-medium text-lg">
                    Nenhum grupo de pesquisa selecionado
                  </p>
                </div>
              )}
            </ResizablePanel>
