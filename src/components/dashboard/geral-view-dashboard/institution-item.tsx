...
import { Copy, Trash, Upload } from 'lucide-react';
        ...
        <div className="p-4 pt-0">
          ...
          <div className="items-center flex justify-between gap-3">
            <div className="flex gap-3 justify-end w-full ">
              <Button
                onClick={() =>
                  onOpen('confirm-delete-institution', {
                    id_delete: props.institution_id,
                    name: props.name,
                  })
                }
                variant={'destructive'}
              ...
              <Button
                onClick={() => {
                  ...
                  toast('Operação realizada', {
                    description:
                      'Id da instituição copiado para área de transferência',
                    action: {
                      label: 'Fechar',
                      onClick: () => {},
                    },
