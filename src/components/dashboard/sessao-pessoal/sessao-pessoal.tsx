...
export function SessaoPessoal() {
  ...
  return (
    <main className="flex flex-1 flex-col gap-4  md:gap-8 ">
      <Helmet>
        <title>Seção de pessoal | Módulo administrativo | {'Simcc'} </title>
        <meta
          name="description"
          content={`Seção de pessoal | Módulo administrativo | ${'Simcc'}`}
        />
          ...
          <Alert className="p-0">
            ...
            <CardContent className="flex mt-6 flex-col gap-4">
              <Button className="w-fit">
                ...
                <label
                  htmlFor="upload"
                  className="cursor-pointer w-full h-full gap-2 flex items-center justify-center"
                >
                  <Plus size={16} />
            ...
            <div className="flex flex-col gap-4">
              <div className="mb-4">
                <HeaderResultTypeHome
                  ...
                  icon={<FilePdf size={24} className="text-gray-400" />}
                />
              </div>
                ...
                <Alert key={index} className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <div className="flex gap-3">
                      ...
                      <p className="text-sm text-gray-500 flex items-center gap-1">
                        <Weight size={12} /> {(file.size / 1024).toFixed(2)} KB
                      </p>
                    </div>
                  </div>
                </Alert>
