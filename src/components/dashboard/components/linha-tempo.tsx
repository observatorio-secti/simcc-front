          ...
          <div>
            ...
            >
              <div className="flex items-center w-full">
                ...
                <div
                  className={`w-8 h-8 cursor-pointer rounded-full border ${item.selected ? 'bg-eng-dark-blue dark:bg-eng-dark-blue text-white' : 'bg-neutral-50 dark:bg-neutral-900'} whitespace-nowrap flex items-center justify-center text-xl font-bold`}
                >
