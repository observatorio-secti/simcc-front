...
export function VincularUsuarioCargo() {
  ...
  //todos os usuarios
  const urlGetStudent = urlGeralAdm + `/s/user/all`;
      ...
      <div className="flex flex-col gap-4 md:gap-8">
        <Alert className="p-6 flex gap-3">
          ...
          <div>
            ...
            <AlertDescription>
              O cargo só pode ser atribuído ao usuário após ele ter realizado
              algum login na plataforma.
            </AlertDescription>
          </div>
        </Alert>
        ...
        {data.map((props, index) => {
          ...
          const filteredResearchers = researcherSearch.filter((researcher) =>
            researcher.roles.some((role) => role.role === props.role),
          );
                    ...
                    <div className="gap-6 flex  items-end">
                      <div className="grid gap-3 w-full">
                        ...
                        <Dialog
                          ...
                          onOpenChange={() =>
                            setOpenPopUpIndex(
                              openPopUpIndex === index ? null : index,
                            )
                          }
                        >
                              ...
                              {pesquisadoreSelecionado
                                ? researcherSearch.find(
                                    (framework) =>
                                      ...
                                      pesquisadoreSelecionado.display_name,
                                  )?.display_name
                          ...
                          <DialogContent className="z-[9999]">
                            <DialogHeader>
                              ...
                              <DialogDescription>
                                Todos os docentes cadastrados no Módulo
                      ...
                      <Button onClick={() => handleSubmitUsuario(props.id)}>
                        <Plus size={16} />
                        Adicionar
                      </Button>
                    </div>
                  ...
                  <div className="flex-col flex gap-3">
                    {filteredResearchers.map((researcher) => (
                      <div
                        ...
                        className="group flex items-center justify-between h-10"
                      >
                        ...
                        <Button
                          onClick={() =>
                            handleDeleteUsuario(props.id, researcher.user_id)
                          }
                          variant={'destructive'}
                          size={'icon'}
