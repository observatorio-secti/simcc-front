              ...
              >
                <div
                  className={`h-full w-2 rounded-l-md dark:border-neutral-800 border border-neutral-200 border-r-0 ${
                    props.occupied_slots === '' || props.occupied_slots === '0'
                      ? 'bg-red-500'
                      : 'bg-green-500'
                  }`}
                ></div>
                ...
                <Alert className="p-0 group rounded-l-none h-auto">
                  ...
                  {dataSelecionado?.academic_activity_name ==
                    props.academic_activity_name &&
                    dataSelecionado.demanding_courses ==
                      props.demanding_courses &&
                    dataSelecionado.schedule == props.schedule && (
                      <div>
                          ...
                          >
                            <dt className="flex items-center gap-2 text-muted-foreground">
                              <div className="w-6 h-6">
                                <img
                                  src={`${urlGeral}ResearcherData/Image?name=${props.researcher_name}`}
                                  alt=""
