        ...
        <TabsContent value="all" className="flex flex-col gap-4 md:gap-8">
          <Alert className="h-[300px] flex items-center justify-center">
            <h1 className="z-[2] text-center max-w-[500px] text-3xl font-bold leading-tight tracking-tighter md:text-5xl lg:leading-[1.1]  md:block mb-4 ">
              Saiba as informações sobre a plataforma
            </h1>
          </Alert>
          ...
          <div className="">
            ...
            >
              <CardHeader className="flex flex-row items-start bg-neutral-100 dark:bg-neutral-800">
                <div className="flex gap-2 items-center text-sm text-gray-500">
                  O Simcc é uma plataforma desenvolvida para centralizar e
                  visualizar de forma abrangente os dados dos pesquisadores da
                  instituição. Integrando informações de diversas fontes, como
                  Lattes, Sucupira, Diretório dos Grupos de Pesquisa (DGP),
                  OpenAlex e Journal Citation Reports (JCR), o Simcc oferece uma
                  visão detalhada e acessível das competências e produções
                  acadêmicas. Todas as informações de produção bibliográfica e
                  técnica apresentadas foram retiradas da Plataforma Lattes com
                  autorização do CNPq e OpenAlex.
                </div>
              </CardHeader>
              ...
              <CardContent className="p-6 text-sm">
                <div className="flex flex-col gap-3">
                  ...
                  <div className="flex gap-2 items-center text-sm text-gray-500">
                    <ul>
                      <li>
                        Artigos Científicos: Detalhamento com informações como
                        Qualis, JCR, DOI, autores e resumo.
                      </li>
                      <li>
                        Livros e Capítulos: Informações sobre Nome do livro,
                        título,ano
                      </li>
                      <li>
                        Propriedade Intelectual: Patentes, marcas, e softwares
                        desenvolvidos.
                      </li>
                      <li>
                        Participação em eventos: Participações e contribuições e
                        eventos acadêmicos.
                      </li>
                      <li>
                        Relatórios Técnicos Participações e contribuições e
                        eventos acadêmicos.
                      </li>
                      <li>
                        Orientações: Participações e contribuições e eventos
                        acadêmicos.
                      </li>
                    </ul>
                  </div>
                  <div className="flex gap-2 items-center text-sm text-gray-500">
                    A plataforma possui operadores booleanos de busca (E ou OU)
                    e é capaz de fazer buscas a partir de perguntas com
