...
export function Info() {
  ...
  return (
    <main className="p-4 md:p-8 bg-neutral-50 dark:bg-neutral-900 text-gray-800 dark:text-gray-100">
      <Helmet>
        <title>Informações | {'Simcc'}</title>
        <meta name="description" content={`Informações | ${'Simcc'}`} />
      ...
      <div className="max-w-[1200px] mx-auto space-y-8">
        ...
        <Alert className="space-y-4 p-8">
          ...
          <p>
            O {platform} é uma plataforma desenvolvida para centralizar e
            visualizar de forma abrangente os dados dos pesquisadores da
            instituição. Integrando informações de diversas fontes, como Lattes,
            Sucupira, Diretório dos Grupos de Pesquisa (DGP), OpenAlex e Journal
            Citation Reports (JCR), o Simcc oferece uma visão detalhada e
            acessível das competências e produções acadêmicas. Todas as
            informações de produção bibliográfica e técnica apresentadas foram
            retiradas da Plataforma Lattes com autorização do CNPq e OpenAlex.
          </p>
        </Alert>

        <Alert className="space-y-4 p-8">
          <h2 className="text-2xl font-semibold">
            Mapeamento de Produções Acadêmicas:
          </h2>

          <ul className="list-disc list-inside space-y-1">
            <li>
              <strong>Artigos Científicos:</strong> Detalhamento completo com
              informações como Qualis, Journal Citation Reports (JCR), DOI,
              autores, ordem de autoria, quantidade de citações, revista,
              idioma, resumo, link para acesso e validação automática com bases
              de dados externas.
            </li>
            <li>
              <strong>Livros e Capítulos:</strong> Registro de livros e
              capítulos publicados, com título, autores, editora, ano de
              publicação e ISBN.
            </li>
            <li>
              <strong>Propriedade Intelectual:</strong> Registro de patentes,
              marcas, softwares. Incluindo, status (concedido, requerido ou
              publicado), titulares e data de registro.
            </li>
            <li>
              <strong>Participação em Eventos:</strong> Apresentações orais,
              pôsteres, mesas-redondas e participação em congressos, simpósios e
              seminários, com título do trabalho, evento, ano e autoria.
            </li>
            <li>
              <strong>Relatórios Técnicos:</strong> Produção de relatórios
              técnicos, pareceres e documentos institucionais com dados do
              projeto vinculado, órgão financiador ou solicitante, autores e ano
              de emissão.
            </li>
            <li>
              <strong>Orientações:</strong> Registro de orientações e
              coorientações em nível de graduação, mestrado, doutorado,
              pós-doutorado e iniciação científica, com dados do orientando,
              tipo de vínculo, título do trabalho e situação (em andamento ou
              concluído).
            </li>
            <li>
              <strong>Textos em Revista:</strong> Publicações em revistas com
              título da matéria, nome da revista e ano de publicação.
            </li>
            <li>
              <strong>Trabalhos em Eventos:</strong> Registros de trabalhos
              completos e resumos expandidos publicados em anais de eventos
              acadêmicos, com título, autoria, evento, ISBN dos anais e ano.
            </li>
            <li>
              <strong>Projetos de Pesquisa:</strong> Detalhamento de projetos de
              pesquisa coordenados ou em que há participação, com título,
              resumo, instituição de execução, agência financiadora, ano de
              ínicio, situação atual (em andamento ou concluído), produções
              associadas.
            </li>
            <li>
              <strong>Cargos e Funções:</strong> Registro de atividades
              administrativas e acadêmicas, incluindo coordenação de cursos,
              chefias de departamento, direção de unidade, representação em
              colegiados e outros; com período de atuação e descrição da função.
            </li>
            <li>
              <strong>Outras Informações Relevantes:</strong> Dados
              complementares como índice H, índice i10, total de citações, além
              de indicadores bibliométricos e métricas de impacto institucional.
            </li>

            <li>
              <strong>Atuação em Grupos de Pesquisa:</strong> Vinculação a
              grupos de pesquisa certificados pelo CNPq, com nome do grupo,
              líder e vice-líder, linha de pesquisa e instituição.
            </li>
          </ul>

          <p>
            A plataforma possui operadores booleanos de busca (E ou OU) e é
            capaz de fazer buscas a partir de perguntas com processamento de
            linguagem natural
          </p>
        </Alert>
                ...
                <Alert className=" rounded-l-none flex gap-3 p-8">
                  <div className="flex flex-1 flex-col">
                    ...
                    <div className="flex gap-4 flex-wrap">
                      <Link to={props.lattes} target="_blank">
                        {' '}
        ...
        <Alert className="space-y-4 p-8">
          ...
          <p className="flex gap-2 items-center ">
            <MapPin size={16} />{' '}
            {false
              ? 'Av. Luís Viana Filho, 5ª Avenida, Plataforma II, B, 1º andar - CAB, Salvador-BA,41745-004'
              : 'Av. Luís Viana Filho, 5ª Avenida, Plataforma II, B, 1º andar - CAB, Salvador-BA,41745-004'}
          </p>
          <p className="flex gap-2 items-center ">
            <Mail size={16} />{' '}
