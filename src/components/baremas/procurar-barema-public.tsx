...
export function ProcurarBaremas() {
  const { idDocumentBarema, setIdDocumentBarema, user } =
    ...
    const fetchData = async () => {
      try {
        ...
        if (userDocSnapshot.size > 0) {
          ...
          const documentExists = userDataArray.some(
            (userData) => userData['Document ID'] === input,
          );
          if (documentExists) {
  ...
  return (
    <>
      <div className="w-full  h-full flex flex-col items-center justify-center">
        <div
          className="w-full h-[300px] mb-6 bg-contain bg-top bg-no-repeat"
        ...
        <div className="w-full h-full items-center justify-center flex flex-col">
          <div className="flex flex-col justify-center max-w-[60vw] w-full">
            <h1 className=" max-w-[900px] text-3xl font-bold leading-tight tracking-tighter md:text-4xl lg:leading-[1.1]  md:block mb-3 ">
              ...
              do barema <br /> e consulte os resultados.
            </h1>
          </div>
