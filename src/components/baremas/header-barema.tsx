      ...
      <div className="flex  gap-6 w-full flex-col  ">
        <div>
          <h1 className=" max-w-[450px] text-3xl font-bold leading-tight tracking-tighter md:text-4xl lg:leading-[1.1]  md:block mb-3 ">
            Criar{' '}
            <strong className="bg-[#719CB8]   rounded-md px-3 pb-2 text-white font-medium">
              barema
            </strong>{' '}
            de avaliação dos pesquisadores
          </h1>
          <p className="max-w-[500px]  text-lg font-light text-foreground">
            O sistema de classificação, é uma estrutura criada para avaliar e
            classificar pesquisadores com base em critérios específicos.
          </p>
        </div>
          ...
          {pesquisadoresSelecionados.slice(0, 8).map((props) => {
            return (
              <div key={props.id} className="group flex transition-all">
                <div
                  className=" rounded-md w-10 h-10 bg-cover bg-center bg-no-repeat group-hover:rounded-l-lg group-hover:rounded-r-none"
                  style={{
                ...
                <div
                  ...
                  className="h-10 w-10  hidden group-hover:flex items-center justify-center transition-all hover:text-neutral-900 dark:bg-neutral-950 bg-white hover:bg-neutral-200 dark:hover:bg-neutral-800 dark:hover:text-neutral-50  text-gray-500 dark:text-white rounded-r-md cursor-pointer"
                >
                  <X size={16} className="" />
                </div>
              </div>
                      ...
                      >
                        <div className="flex items-center justify-between w-full">
                          <div className="flex items-center gap-3 font-medium">
                            <div
                              className="bg-cover bg-center bg-no-repeat h-6 w-6  rounded-md  "
                              style={{
                                backgroundImage: `url(${urlGeral}ResearcherData/Image?researcher_id=${props.id}) `,
                              }}
                            ></div>
