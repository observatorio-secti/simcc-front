...
export function MeusBaremasHome() {
  ...
  const { user, urlGeral, idDocumentBarema, setIdDocumentBarema } =
              ...
              userData.map((user) => (
                <div onClick={() => handleBarema(user['Document ID'])}>
                  <Alert className="min-h-[180px]">
                    <div>
                      <h3 className="font-medium text-xl text-gary-500">
                        {user.name}
                      </h3>
                    ...
                    <div className="flex justify-between gap-3">
                      ...
                      <div className="flex gap-3 text-gray-400 items-center">
                        ...
                        {user.pesquisadores.length > 3 ? (
                          <p>+ {user.pesquisadores.length - 3}</p>
                        ) : (
                          ``
                        )}
                      </div>
