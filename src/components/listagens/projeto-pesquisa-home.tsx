...
function ProjectChartsAccordion({
  loading,
  chartData,
}: {
  loading: boolean;
  chartData: ChartMetricProject[];
}) {
      ...
      <AccordionItem value="item-1">
        <div className="flex ">
          <HeaderResultTypeHome
            title="Gráfico de quantidade total de novos projetos de pesquisa"
...
export function ProjetoPesquisaHome() {
  ...
  useEffect(() => {
    ...
    const fetchChartData = async () => {
      ...
      try {
        const response = await fetch(urlChartProject, {
          ...fetchOptions,
  ...
  return (
    <div className="grid grid-cols-1 gap-4 pb-16 ">
      ...
      <ProjectChartsAccordion loading={loadingCharts} chartData={chartData} />
