...
function WorkEventChartsAccordion({
  loading,
  chartData,
}: {
  loading: boolean;
  chartData: ChartMetricWorkEvent[];
}) {
...
function WorkEventListAccordion({
  loading,
  publicacoes,
  typeVisu,
  setTypeVisu,
...
export function WorkEventHome() {
  ...
  useEffect(() => {
    ...
    const fetchChartData = async () => {
      ...
      try {
        const response = await fetch(urlChartEvents, {
          ...fetchOptions,
