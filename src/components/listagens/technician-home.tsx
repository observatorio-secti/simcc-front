...
export function TechnicianHome() {
  ...
  const urlTermPublicacoes = `${urlGeral}ufmg/technician`;
  ...
  const filteredTotal = Array.isArray(publicacoes)
        ...
        <AccordionItem value="item-1" className="w-full">
          <div className="flex ">
            <HeaderResultTypeHome
              title="Gráfico dos técnicos administrativos"
        ...
        <AccordionItem value="item-1">
          ...
          <AccordionContent className="w-full">
            {typeVisu == 'block' ? (
              ...
              <DataTable columns={columnsTecnicos} data={filteredTotal} />
            )}
          </AccordionContent>
        </AccordionItem>
      </Accordion>
