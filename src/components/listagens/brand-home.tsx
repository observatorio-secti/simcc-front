...
function BrandChartsAccordion({
  loading,
  chartData,
}: {
  loading: boolean;
  chartData: ChartMetricBrand[];
}) {
      ...
      <AccordionItem value="item-1">
        <div className="flex ">
          <HeaderResultTypeHome
            title="Gráfico de quantidade total de marcas"
...
export function BrandHome() {
  ...
  useEffect(() => {
    ...
    const fetchChartData = async () => {
      ...
      try {
        const response = await fetch(urlChartBrand, {
          ...fetchOptions,
